(() => {
  ...
  function showView(v) {
    ...
    else { $('#portal-title').textContent=({'projects':'My Projects','project-detail':'Project','files':'Files','messages':'Messages','payments':'Payments','new-project':'Start New Project','account':'Account'})[v]||'Client Portal'; $('#portal-subtitle').textContent='ATS · Client Portal'; }
