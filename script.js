...
(()=>{const css=document.createElement('link');css.rel='stylesheet';css.href='/visual-overrides.css?v=1';document.head.appendChild(css);const load=(src,next)=>{const s=document.createElement('script');s.src=src;s.onload=()=>next&&next();document.head.appendChild(s)};load('/cover-sprite.js?v=1',()=>load('/hero-visual.js?v=2',()=>load('/site-upgrade.js?v=3')));})();
