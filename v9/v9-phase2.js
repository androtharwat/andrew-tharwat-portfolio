(() => {
  ...
  const copy={
    en:{
      ...
      contact:{eyebrow:'05 · CONTACT',title:'Who should we reply to?',guide:'Add your name and a valid email address so ATS can confirm the request and continue the client journey.',labels:['NAME','EMAIL','PHONE / WHATSAPP','COMPANY / ORGANIZATION']},
      back:'← BACK',copy:'COPY BRIEF',send:'SEND PROJECT BRIEF →',validation:'Add your name and a valid email address before sending.',summary:['PROJECT TYPE','CHALLENGE','EXPERTISE','TIMELINE','CONTACT']
    },
    ar:{
      ...
      contact:{eyebrow:'05 · التواصل',title:'مع من نتواصل؟',guide:'أضف اسمك وبريدًا إلكترونيًا صحيحًا حتى نؤكد الطلب ونكمل معك مسار العميل.',labels:['الاسم','البريد الإلكتروني','الهاتف / واتساب','الشركة / الجهة']},
      back:'السابق →',copy:'نسخ البريف',send:'إرسال بريف المشروع ←',validation:'أضف الاسم وبريدًا إلكترونيًا صحيحًا قبل الإرسال.',summary:['نقطة البداية','التحدي','الخبرات','التوقيت','التواصل']
    }
  };
