(() => {
  ...
  function refineStart(){
    ...
    if(cards[0]){cards[0].href='/hse/';copy($('h3',cards[0]),'Solve an HSE or safety issue','حل مشكلة HSE أو سلامة');copy($('.human-card-action span',cards[0]),'OPEN HSE WORLD','افتح عالم HSE');}
