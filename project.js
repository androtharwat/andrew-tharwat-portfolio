...
function stringArtMarkup(p,mediaItems){
  ...
  const copy=ar?{
    ...
    labUpload:'اختر صورة',labDrop:'اضغط أو اسحب الصورة',labPrivacy:'محلي على جهازك',labMode:'الخيط',labMono:'أسود',labColor:'5 ألوان',labQuality:'الجودة',labFast:'سريع',labDetail:'PRO',labShare:'MASTER',labFrame:'اضبط الكادر',labZoom:'تكبير',labFit:'ملاءمة',labCenter:'توسيط',labRotate:'تدوير',labContrast:'التباين',labGamma:'الظل',labGenerate:'ابدأ الرسم',labReady:'ارفع صورة وابدأ',labOriginal:'اضبط الصورة',labResult:'النتيجة',labProgress:'جارٍ الحساب…',labReplay:'إعادة',labDownload:'PNG عالي الجودة',labVideo:'فيديو البناء',labShareBtn:'مشاركة',labSpeak:'الأرقام صوتيًا',labSequence:'المسار',labProd:'MASTER يستخدم 280 مسمار وحتى 4500 خط — قريب من كثافة التنفيذ الحقيقي.',labBrand:'كل ملف محفوظ يحمل علامة ATS.',
    ...
    labUpload:'CHOOSE A PHOTO',labDrop:'CLICK OR DROP PHOTO',labPrivacy:'LOCAL ON YOUR DEVICE',labMode:'THREAD',labMono:'BLACK',labColor:'5-COLOR',labQuality:'QUALITY',labFast:'QUICK',labDetail:'PRO',labShare:'MASTER',labFrame:'FRAME',labZoom:'ZOOM',labFit:'FIT',labCenter:'CENTER',labRotate:'ROTATE',labContrast:'CONTRAST',labGamma:'SHADOW',labGenerate:'BUILD MY PORTRAIT',labReady:'UPLOAD + START',labOriginal:'FRAME PHOTO',labResult:'RESULT',labProgress:'COMPUTING…',labReplay:'REPLAY',labDownload:'HQ PNG',labVideo:'BUILD VIDEO',labShareBtn:'SHARE',labSpeak:'SPEAK PINS',labSequence:'ROUTE',labProd:'MASTER uses 280 nails and up to 4,500 lines — close to physical-production density.',labBrand:'Every saved file carries the ATS mark.',
